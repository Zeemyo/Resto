            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="id_laporan" name="id_laporan" value=" <?= $data_Id_laporan['id_laporan']; ?>" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="jumlah" name="jumlah" value=" <?= $data_Id_laporan['jumlah']; ?>">
                            <small class="text-danger">
