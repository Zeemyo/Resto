<div class="container pt-5">
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb ">
			...
			<li class="breadcrumb-item active" aria-current="page">Edit Data Order</li>
		</ol>
	</nav>
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="id_order" name="id_order" value=" <?= $data_order['id_order']; ?>" readonly>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="no_meja" name="no_meja" value=" <?= $data_order['no_meja']; ?>">
							<small class="text-danger">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="total_harga" name="total_harga" value=" <?= $data_order['total_harga']; ?>">
							<small class="text-danger">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="uang_bayar" name="uang_bayar" value="<?= $data_order['uang_bayar']; ?>">
							<small class="text-danger">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="uang_kembali" name="uang_kembali" value="<?= $data_order['uang_kembali']; ?>">
							<small class="text-danger">
