    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">     
                    <h5 class="card-title"><b>ID Pesan :</b><br><?= $data_pesan['id_pesan'] ?></h5>
                    <p class="card-text"><b>ID Order :</b><br><?= $data_pesan['id_order'] ?></p>
                    <p class="card-text"><b>ID User :</b><br><?= $data_pesan['id_user'] ?></p> 
                    <p></p>
