            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="id_minuman" name="id_minuman" value=" <?= $data_minuman['id_minuman']; ?>" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_minuman" name="nama_minuman" value=" <?= $data_minuman['nama_minuman']; ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="harga_minuman" name="harga_minuman" rows="3"><?= $data_minuman['harga_minuman']; ?></textarea>
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="stok_minuman" name="stok_minuman" rows="3"><?= $data_minuman['stok_minuman']; ?></textarea>
                            <small class="text-danger">
